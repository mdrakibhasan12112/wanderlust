...
export function EditForm({destination}) {
 ...
 const onSubmit = async e => {
  ...
  return (
    <Modal>
      <Button variant="secondary" className="text-center items-center">
        <Edit /> Edit
      </Button>
      <Modal.Backdrop>
        <Modal.Container placement="auto">
          <Modal.Dialog className="sm:max-w-2xl">
            <Modal.CloseTrigger />
            <Modal.Header>
              <Modal.Heading>Update data</Modal.Heading>
            </Modal.Header>
            <Modal.Body className="p-6">
              <Surface variant="default">
                <form onSubmit={onSubmit} className="p-10 space-y-8 shadow-xl mt-4">
